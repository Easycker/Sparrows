...
C_PRTREE* prtree_Create_Ex(C_PRTREE *tag_tree,size_t data_size,BOOL_ (*compare_fun)(),void (*free_fun)());
...
PRTREE_NODE prtree_Get(void *in_data,BOOL_ (*ensure_fun)(),C_PRTREE *tag_tree);
