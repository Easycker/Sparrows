...
C_BHTREE* bhtree_Create_Ex(C_BHTREE *tag_tree,size_t data_size,BOOL_ (*compare_fun)(),void (*free_fun)());
...
BHTREE_NODE bhtree_Get(void *in_data,BOOL_ (*ensure_fun)(),C_BHTREE *tag_tree);
